...
const SECOND_WEB_SERVER_HOST = process.env.RAILWAY_TCP_HOST || 'shortline.proxy.rlwy.net';
const SECOND_WEB_SERVER_PORT = process.env.RAILWAY_TCP_PORT || 36852; // Railway TCP proxy port
